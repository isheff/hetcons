...
from_Phase_2b_args record = T.TStruct $ Map.fromList $ M.catMaybes
  [ (\_v530 -> P.Just (1, ("phase_2b_message",from_Signed_Message _v530))) $ phase_2b_args_phase_2b_message record
  ]
...
to_Phase_2b_args (T.TStruct fields) = Phase_2b_args{
  phase_2b_args_phase_2b_message = P.maybe (phase_2b_args_phase_2b_message default_Phase_2b_args) (\(_,_val532) -> (case _val532 of {T.TStruct _val533 -> (to_Signed_Message (T.TStruct _val533)); _ -> P.error "wrong type"})) (Map.lookup (1) fields)
  }
...
from_Phase_2b_result record = T.TStruct $ Map.fromList 
  (let exns = M.catMaybes [ (\_v536 -> (1, ("no_supported_hash_sha2_descriptor_provided",from_No_Supported_Hash_Sha2_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_sha2_descriptor_provided record, (\_v536 -> (2, ("descriptor_does_not_match_hash_sha2",from_Descriptor_Does_Not_Match_Hash_Sha2 _v536))) <$> phase_2b_result_descriptor_does_not_match_hash_sha2 record, (\_v536 -> (3, ("no_supported_hash_sha3_descriptor_provided",from_No_Supported_Hash_Sha3_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_sha3_descriptor_provided record, (\_v536 -> (4, ("descriptor_does_not_match_hash_sha3",from_Descriptor_Does_Not_Match_Hash_Sha3 _v536))) <$> phase_2b_result_descriptor_does_not_match_hash_sha3 record, (\_v536 -> (5, ("no_supported_hash_type_descriptor_provided",from_No_Supported_Hash_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_type_descriptor_provided record, (\_v536 -> (6, ("descriptor_does_not_match_hash",from_Descriptor_Does_Not_Match_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_hash record, (\_v536 -> (7, ("invalid_public_crypto_key_X509",from_Invalid_Public_Crypto_Key_X509 _v536))) <$> phase_2b_result_invalid_public_crypto_key_X509 record, (\_v536 -> (8, ("invalid_public_crypto_key_PGP",from_Invalid_Public_Crypto_Key_PGP _v536))) <$> phase_2b_result_invalid_public_crypto_key_PGP record, (\_v536 -> (9, ("no_supported_public_crypto_key_type_descriptor_provided",from_No_Supported_Public_Crypto_Key_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_public_crypto_key_type_descriptor_provided record, (\_v536 -> (10, ("descriptor_does_not_match_public_crypto_key",from_Descriptor_Does_Not_Match_Public_Crypto_Key _v536))) <$> phase_2b_result_descriptor_does_not_match_public_crypto_key record, (\_v536 -> (11, ("descriptor_does_not_match_crypto_ID_hash",from_Descriptor_Does_Not_Match_Crypto_ID_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_crypto_ID_hash record, (\_v536 -> (12, ("no_supported_crypto_ID_type_descriptor_provided",from_No_Supported_Crypto_ID_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_crypto_ID_type_descriptor_provided record, (\_v536 -> (13, ("descriptor_does_not_match_crypto_ID",from_Descriptor_Does_Not_Match_Crypto_ID _v536))) <$> phase_2b_result_descriptor_does_not_match_crypto_ID record, (\_v536 -> (14, ("invalid_signed_hash",from_Invalid_Signed_Hash _v536))) <$> phase_2b_result_invalid_signed_hash record, (\_v536 -> (15, ("descriptor_does_not_match_signed_hash",from_Descriptor_Does_Not_Match_Signed_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_signed_hash record, (\_v536 -> (16, ("unparsable_hashable_message",from_Unparsable_Hashable_Message _v536))) <$> phase_2b_result_unparsable_hashable_message record, (\_v536 -> (17, ("invalid_address",from_Invalid_Address _v536))) <$> phase_2b_result_invalid_address record, (\_v536 -> (18, ("impossible_observer_graph",from_Impossible_Observer_Graph _v536))) <$> phase_2b_result_impossible_observer_graph record, (\_v536 -> (19, ("invalid_proposal_1a",from_Invalid_Proposal_1a _v536))) <$> phase_2b_result_invalid_proposal_1a record, (\_v536 -> (20, ("invalid_Phase_1b",from_Invalid_Phase_1b _v536))) <$> phase_2b_result_invalid_Phase_1b record, (\_v536 -> (21, ("invalid_Phase_2a",from_Invalid_Phase_2a _v536))) <$> phase_2b_result_invalid_Phase_2a record, (\_v536 -> (22, ("invalid_Phase_2b",from_Invalid_Phase_2b _v536))) <$> phase_2b_result_invalid_Phase_2b record, (\_v536 -> (23, ("invalid_Proof_of_Consensus",from_Invalid_Proof_of_Consensus _v536))) <$> phase_2b_result_invalid_Proof_of_Consensus record]
  in if P.not (P.null exns) then exns else M.catMaybes
    [ (\_v536 -> (1, ("no_supported_hash_sha2_descriptor_provided",from_No_Supported_Hash_Sha2_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_sha2_descriptor_provided record
    , (\_v536 -> (2, ("descriptor_does_not_match_hash_sha2",from_Descriptor_Does_Not_Match_Hash_Sha2 _v536))) <$> phase_2b_result_descriptor_does_not_match_hash_sha2 record
    , (\_v536 -> (3, ("no_supported_hash_sha3_descriptor_provided",from_No_Supported_Hash_Sha3_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_sha3_descriptor_provided record
    , (\_v536 -> (4, ("descriptor_does_not_match_hash_sha3",from_Descriptor_Does_Not_Match_Hash_Sha3 _v536))) <$> phase_2b_result_descriptor_does_not_match_hash_sha3 record
    , (\_v536 -> (5, ("no_supported_hash_type_descriptor_provided",from_No_Supported_Hash_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_hash_type_descriptor_provided record
    , (\_v536 -> (6, ("descriptor_does_not_match_hash",from_Descriptor_Does_Not_Match_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_hash record
    , (\_v536 -> (7, ("invalid_public_crypto_key_X509",from_Invalid_Public_Crypto_Key_X509 _v536))) <$> phase_2b_result_invalid_public_crypto_key_X509 record
    , (\_v536 -> (8, ("invalid_public_crypto_key_PGP",from_Invalid_Public_Crypto_Key_PGP _v536))) <$> phase_2b_result_invalid_public_crypto_key_PGP record
    , (\_v536 -> (9, ("no_supported_public_crypto_key_type_descriptor_provided",from_No_Supported_Public_Crypto_Key_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_public_crypto_key_type_descriptor_provided record
    , (\_v536 -> (10, ("descriptor_does_not_match_public_crypto_key",from_Descriptor_Does_Not_Match_Public_Crypto_Key _v536))) <$> phase_2b_result_descriptor_does_not_match_public_crypto_key record
    , (\_v536 -> (11, ("descriptor_does_not_match_crypto_ID_hash",from_Descriptor_Does_Not_Match_Crypto_ID_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_crypto_ID_hash record
    , (\_v536 -> (12, ("no_supported_crypto_ID_type_descriptor_provided",from_No_Supported_Crypto_ID_Type_Descriptor_Provided _v536))) <$> phase_2b_result_no_supported_crypto_ID_type_descriptor_provided record
    , (\_v536 -> (13, ("descriptor_does_not_match_crypto_ID",from_Descriptor_Does_Not_Match_Crypto_ID _v536))) <$> phase_2b_result_descriptor_does_not_match_crypto_ID record
    , (\_v536 -> (14, ("invalid_signed_hash",from_Invalid_Signed_Hash _v536))) <$> phase_2b_result_invalid_signed_hash record
    , (\_v536 -> (15, ("descriptor_does_not_match_signed_hash",from_Descriptor_Does_Not_Match_Signed_Hash _v536))) <$> phase_2b_result_descriptor_does_not_match_signed_hash record
    , (\_v536 -> (16, ("unparsable_hashable_message",from_Unparsable_Hashable_Message _v536))) <$> phase_2b_result_unparsable_hashable_message record
    , (\_v536 -> (17, ("invalid_address",from_Invalid_Address _v536))) <$> phase_2b_result_invalid_address record
    , (\_v536 -> (18, ("impossible_observer_graph",from_Impossible_Observer_Graph _v536))) <$> phase_2b_result_impossible_observer_graph record
    , (\_v536 -> (19, ("invalid_proposal_1a",from_Invalid_Proposal_1a _v536))) <$> phase_2b_result_invalid_proposal_1a record
    , (\_v536 -> (20, ("invalid_Phase_1b",from_Invalid_Phase_1b _v536))) <$> phase_2b_result_invalid_Phase_1b record
    , (\_v536 -> (21, ("invalid_Phase_2a",from_Invalid_Phase_2a _v536))) <$> phase_2b_result_invalid_Phase_2a record
    , (\_v536 -> (22, ("invalid_Phase_2b",from_Invalid_Phase_2b _v536))) <$> phase_2b_result_invalid_Phase_2b record
    , (\_v536 -> (23, ("invalid_Proof_of_Consensus",from_Invalid_Proof_of_Consensus _v536))) <$> phase_2b_result_invalid_Proof_of_Consensus record
    ]
    )
...
to_Phase_2b_result (T.TStruct fields) = Phase_2b_result{
  phase_2b_result_no_supported_hash_sha2_descriptor_provided = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val539 -> (to_No_Supported_Hash_Sha2_Descriptor_Provided (T.TStruct _val539)); _ -> P.error "wrong type"})) (Map.lookup (1) fields),
  phase_2b_result_descriptor_does_not_match_hash_sha2 = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val540 -> (to_Descriptor_Does_Not_Match_Hash_Sha2 (T.TStruct _val540)); _ -> P.error "wrong type"})) (Map.lookup (2) fields),
  phase_2b_result_no_supported_hash_sha3_descriptor_provided = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val541 -> (to_No_Supported_Hash_Sha3_Descriptor_Provided (T.TStruct _val541)); _ -> P.error "wrong type"})) (Map.lookup (3) fields),
  phase_2b_result_descriptor_does_not_match_hash_sha3 = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val542 -> (to_Descriptor_Does_Not_Match_Hash_Sha3 (T.TStruct _val542)); _ -> P.error "wrong type"})) (Map.lookup (4) fields),
  phase_2b_result_no_supported_hash_type_descriptor_provided = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val543 -> (to_No_Supported_Hash_Type_Descriptor_Provided (T.TStruct _val543)); _ -> P.error "wrong type"})) (Map.lookup (5) fields),
  phase_2b_result_descriptor_does_not_match_hash = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val544 -> (to_Descriptor_Does_Not_Match_Hash (T.TStruct _val544)); _ -> P.error "wrong type"})) (Map.lookup (6) fields),
  phase_2b_result_invalid_public_crypto_key_X509 = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val545 -> (to_Invalid_Public_Crypto_Key_X509 (T.TStruct _val545)); _ -> P.error "wrong type"})) (Map.lookup (7) fields),
  phase_2b_result_invalid_public_crypto_key_PGP = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val546 -> (to_Invalid_Public_Crypto_Key_PGP (T.TStruct _val546)); _ -> P.error "wrong type"})) (Map.lookup (8) fields),
  phase_2b_result_no_supported_public_crypto_key_type_descriptor_provided = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val547 -> (to_No_Supported_Public_Crypto_Key_Type_Descriptor_Provided (T.TStruct _val547)); _ -> P.error "wrong type"})) (Map.lookup (9) fields),
  phase_2b_result_descriptor_does_not_match_public_crypto_key = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val548 -> (to_Descriptor_Does_Not_Match_Public_Crypto_Key (T.TStruct _val548)); _ -> P.error "wrong type"})) (Map.lookup (10) fields),
  phase_2b_result_descriptor_does_not_match_crypto_ID_hash = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val549 -> (to_Descriptor_Does_Not_Match_Crypto_ID_Hash (T.TStruct _val549)); _ -> P.error "wrong type"})) (Map.lookup (11) fields),
  phase_2b_result_no_supported_crypto_ID_type_descriptor_provided = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val550 -> (to_No_Supported_Crypto_ID_Type_Descriptor_Provided (T.TStruct _val550)); _ -> P.error "wrong type"})) (Map.lookup (12) fields),
  phase_2b_result_descriptor_does_not_match_crypto_ID = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val551 -> (to_Descriptor_Does_Not_Match_Crypto_ID (T.TStruct _val551)); _ -> P.error "wrong type"})) (Map.lookup (13) fields),
  phase_2b_result_invalid_signed_hash = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val552 -> (to_Invalid_Signed_Hash (T.TStruct _val552)); _ -> P.error "wrong type"})) (Map.lookup (14) fields),
  phase_2b_result_descriptor_does_not_match_signed_hash = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val553 -> (to_Descriptor_Does_Not_Match_Signed_Hash (T.TStruct _val553)); _ -> P.error "wrong type"})) (Map.lookup (15) fields),
  phase_2b_result_unparsable_hashable_message = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val554 -> (to_Unparsable_Hashable_Message (T.TStruct _val554)); _ -> P.error "wrong type"})) (Map.lookup (16) fields),
  phase_2b_result_invalid_address = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val555 -> (to_Invalid_Address (T.TStruct _val555)); _ -> P.error "wrong type"})) (Map.lookup (17) fields),
  phase_2b_result_impossible_observer_graph = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val556 -> (to_Impossible_Observer_Graph (T.TStruct _val556)); _ -> P.error "wrong type"})) (Map.lookup (18) fields),
  phase_2b_result_invalid_proposal_1a = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val557 -> (to_Invalid_Proposal_1a (T.TStruct _val557)); _ -> P.error "wrong type"})) (Map.lookup (19) fields),
  phase_2b_result_invalid_Phase_1b = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val558 -> (to_Invalid_Phase_1b (T.TStruct _val558)); _ -> P.error "wrong type"})) (Map.lookup (20) fields),
  phase_2b_result_invalid_Phase_2a = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val559 -> (to_Invalid_Phase_2a (T.TStruct _val559)); _ -> P.error "wrong type"})) (Map.lookup (21) fields),
  phase_2b_result_invalid_Phase_2b = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val560 -> (to_Invalid_Phase_2b (T.TStruct _val560)); _ -> P.error "wrong type"})) (Map.lookup (22) fields),
  phase_2b_result_invalid_Proof_of_Consensus = P.maybe (P.Nothing) (\(_,_val538) -> P.Just (case _val538 of {T.TStruct _val561 -> (to_Invalid_Proof_of_Consensus (T.TStruct _val561)); _ -> P.error "wrong type"})) (Map.lookup (23) fields)
  }
